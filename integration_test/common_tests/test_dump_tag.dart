...
Future<void> commonDumpTagExec(WidgetTester tester, MockNfcAdapter mockAdapter, String expectedSnackBarMessage) async{
  ...
  // Only if the dump was supposed to be successful
    if (mockAdapter.currentTag!.denyAuthList.isEmpty){
    // File exists
