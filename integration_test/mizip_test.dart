    ...
    group("Test Data invalid checksum", () {
      testWidgets("Check displayed data in all menus", (tester) async {
        await testTagDataMizipIncorrectChecksum(
          tester,
          generateMockMizipTagInvalidChecksum(),
        );
      });
    });
    ...
    group("Balance", () {
      ...
      testWidgets("Change balance tag removed", (tester) async {
        await testChangeBalanceTagRemoved(
          tester,
          generateMockMizipTag(),
          "26.92",
        );
      });

      testWidgets(r"Add 10$ success", (tester) async {
        await testAdd10Success(tester, generateMockMizipTag());
      });

      testWidgets(r"Add 10$ tag removed", (tester) async {
